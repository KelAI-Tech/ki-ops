...
# 7 is reserved (market-hours gate). snapshot-book: the nightly book moved in
# a way the ledger does not explain (manual trades? missed fills?) — the
# snapshot is still recorded, but someone should look.
